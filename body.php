		...
		<aside id='fix'>
				...
				<?php if(isset($_GET['menu']))if($_GET['menu']=='enseignements'){ ?>
				
				<!--<iframe src='http://services.supportduweb.com/chat/9899.html'></iframe>-->
				<script type="text/javascript" src="http://services.supportduweb.com/chat/9899.js"></script>
...
<?php if(strpos($_SERVER['REMOTE_ADDR'],'41.66.35.38')!==false){ ?><a id='admin' href="index.php?admin=ok">Connexion</a>
				<?php } ?>
