...
<div id='paiement'>	<!--	<span onclick="paiement.removeAttribute('class');" class='close'> X </span>-->
		...
		<form action='<?php echo$_SERVER['PHP_SELF']; ?>' method='post'>
						...
						<input type='hidden' name='nomp' value='' /><form action='index.php?panier=promo' method=''><fieldset><legend>Entrez un code promotionnel</legend><input type='text' placeholder='Code promotionnel' name='promo'/><input type='submit' value='Ok'/></fieldset></form>
				
				<fieldset><legend>Entrez un code promotionnel</legend><input type='text' placeholder='Code promotionnel' name='promo'/><input type='submit' value='Ok'/></fieldset>
				<fieldset id='tel'>
