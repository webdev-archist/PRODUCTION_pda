...
?>		
<input type='button' class='shinelivredor' value="&Eacute;crire vous aussi dans notre livre d'or" style='position:relative;top:0;width:100%;cursor:pointer;' onclick='send_msg_livredor()'/>
</div>