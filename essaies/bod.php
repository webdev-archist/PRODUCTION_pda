...
fildariane($page);
				if(isset($_GET['menu']))
						switch($_GET['menu']){
								case"retraites-de-priere-spirituelles-abidjan":case"retraite-de-priere-spirituelle-esprit-saint-gregorienne":case"retraite-spirituelle-abidjan-week-ends-rosaire":case"location-espace-de-priere-abidjan":case"assistance-spirituelle-abidjan":retraite();
								break;
								case"vente-en-ligne":vente();
								break;
								case"dioceses":diocese();
								break;
								case "vente-en-ligne-objets-religieux-catholique":echo vente('objet');
								break;
								case "vente-en-ligne-publications-chretiennes":echo vente('publication');
								break;
								case "puissance-divine-librairie":bal('h2',array($Bh1[0]));bal('h3',$Bh2[0]);lieux();include('librairie.php');
								break;
								case "puissance-divine-fraternite-librairie-sanctuaire":bal('h2',$Bh1);bal('h3',$Bh2);lieux();
								break;
								case "puissance-divine-sanctuaire":bal('h2',array($Bh1[1]));bal('h3',$Bh2[1]);lieux();include('bolobi.php');
								break;
								case "puissance-divine-fraternite":bal('h2',array($Bh1[2]));bal('h3',$Bh2[2]);lieux();include('fraternite.php');
								break;
								...
								break;
								default:?>
										<iframe style='display:block;' src="//www.youtube.com/embed/xuYreqSDgHA" frameborder="0" allowfullscreen></iframe><br/>
										La Fraternité Puissance Divine d'Amour d'Abidjan a pour objectifs de :<br/><ul><li><strong>Sanctifier par la <strong>prière</strong> et la pratique de la <strong>charité</strong></li><li>Apporter <strong>assistance spirituelle</strong> et psychique.</li><li>Universaliser l'<strong>invocation à l'Esprit Saint</strong></li><li><strong>Vendre des objets de piété</strong> et des <strong>livres religieux</strong>.</li><li>Evangéliser par la diffusion de <strong>l'&Eacute;vangile Révélé</strong>.</li><li>Rassembler les apôtres et disciples du <strong>saint-esprit</strong>.</li></ul>
								<?php break;
						}
