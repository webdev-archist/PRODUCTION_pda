...
<?php 
		if(isset($_GET['admin']))
				...
				<form id='rs_admin'>
						...
						<button onclick='nl("");'>Envoyer emails newsletter</button>
						<button onclick='see_nl(this,this.form);'>Voir le lien</button>
						<textarea rows="10" name="nl_emails" id="nl_emails" placeholder="Selectionner une newsletter pour remplir cette case" readonly></textarea><div id="nl_emails_response"></div><button onclick='send_emails(this,this.form);'>Envoyer emails !</button>
						<button onclick='send_rs(this,this.form);'>Envoyer sur Facebook !</button>
						<button onclick='send_rs(this,this.form);'>Envoyer sur Twitter !</button>
						<button onclick='send_rs(this,this.form);'>Envoyer sur Google+ !</button>
				</form>
				<?php }
