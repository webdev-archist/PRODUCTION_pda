<?php 	
		...
		if(!isset($_POST['phone_compte_user'])){
				echo'Votre réservation est bien effectif, vous pouvez régler cette réservation à n\'importe quel moment en nous contactant au 09 - 36 - 06 - 72.';
		}else{
?>
<div>
			...
			<div class='booking-main-wrapper'>
				...
				<div class='booking-main' style='border-left:solid #40A5C3;background:wheat;padding: 20px 50px 20px;'>
					...
					<p>
							...
							Toutes les informations concernant votre commande viennent de vous être envoyées à:<br><?php echo$_POST['email']; ?><br/>
							Enfin, pour valider votre commande, voici l'opération à effectuer:<br>
