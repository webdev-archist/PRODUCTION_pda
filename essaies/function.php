...
function fildariane($x)
{				if(isset($_GET['panier']))echo"<h1 id='h1panier'>";else echo"<h1>";
				$keyw=array();
				$keywz=array();
				...
				echo"<a href='http://librairie-puissance-divine.ci' title=".$keyw[rand(0,4)]."><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]." title=".$keyw[rand(0,4)]." width='1'/>Accueil</a>";
				if(isset($_GET['menu']))
						switch($_GET['menu']){
								case"objectifs":
										echo"><a href='http://librairie-puissance-divine.ci?menu=priere' title=".$keyw[rand(0,4)]."><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]." title=".$keywz[rand(0,4)]." width='1'/>Nos objectifs</a>";
								break;
								case"retraites-de-priere-spirituelles-abidjan":
										echo"><a href='http://librairie-puissance-divine.ci?menu=priere' title=".$keyw[rand(0,4)]."><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]." title=".$keywz[rand(0,4)]." width='1'/>Retraites et Prière spirituelles</a>";
								break;
								...
								echo"><a href='http://librairie-puissance-divine.ci?menu=priere' title=".$keyw[rand(0,4)]."><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]."  title=".$keywz[rand(0,4)]." width='1'/>Retraites et Prière spirituelles</a>";
								echo"><a href='http://librairie-puissance-divine.ci?menu=".$_GET['menu']."' title=".$keyw[rand(0,4)]." ><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]."  title=".$keywz[rand(0,4)]."  width='1'/>$a</a>";
								break;
								case"enseignements-spirituels-chretien-catholique":
								echo"><a href='http://librairie-puissance-divine.ci?menu=enseignements' title=".$keyw[rand(0,4)]." ><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]."  title=".$keywz[rand(0,4)]."  width='1'/>Enseignements spirituels</a>";
								break;
								case"archive_enseignements":
								echo"><a href='http://librairie-puissance-divine.ci?menu=enseignements' title=".$keyw[rand(0,4)]." ><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]."  title=".$keywz[rand(0,4)]."  width='1'/>Enseignements spirituels</a>";
								echo"><a href='http://librairie-puissance-divine.ci?menu=archive_enseignements' title=".$keyw[rand(0,4)]." ><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]."  title=".$keywz[rand(0,4)]."  width='1'/>Liste d'Enseignements</a>";
								break;
								case"vente-en-ligne":
								echo"><a href='http://librairie-puissance-divine.ci?menu=vente' title=".$keyw[rand(0,4)]." ><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]."  title=".$keywz[rand(0,4)]."  width='1'/><strong>Ecommerce</strong></a>";
								break;
								...
								echo"><a href='http://librairie-puissance-divine.ci?menu=".$_GET['menu']."' title=".$keyw[rand(0,4)]." ><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]."  title=".$keywz[rand(0,4)]."  width='1'/>Lieux PuissanceDivine</a>";
								break;
								...
								echo"><a href='http://librairie-puissance-divine.ci?menu=lieux-activites' title=".$keyw[rand(0,4)]." ><img src='http://librairie-puissance-divine.ci/images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt=".$keywz[rand(0,4)]."  title=".$keywz[rand(0,4)]."  width='1'/>Lieux PuissanceDivine</a>";
