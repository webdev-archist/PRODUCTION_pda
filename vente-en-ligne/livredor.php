<?php
		if(isset($_POST['pseudo']))
				if(!strpos_array($_POST['texte'],array('viagra','cigarette','shipping','cheap','href','buy','online','cialis'))&&!strpos_array($_POST['pseudo'],array('viagra','cigarette','shipping','cheap','href','buy','online','cialis'))){
