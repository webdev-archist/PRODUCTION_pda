<header id='vente_en_ligne'>
		<h1><a id='logo' href='index.php'><img src='./../images/ecommerce-chretien-notre-dame-toute-graces.jpg' alt="Librairie Puisance Divine, Abidjan, cocody 2 plateaux" height='200px'/></a><a href='index.php?menu=lieux-activites'><img src='./../images/ecommerce-catholique-saint-esprit-Dieu-amour.png' alt="Librairie Puisance Divine, Abidjan, cocody 2 plateaux" /></a><span>Librairie</span> Puissance Divine</h1>
		<h2><strong>&Eacute;vangélisation</strong>, <strong>Prière</strong> et <strong>Assistance spirituelle</strong></h2>
		
		<?php fildariane($page,'h3 id="vente_fil"',$v);$n=$v; ?>
		<menu id="menu">
