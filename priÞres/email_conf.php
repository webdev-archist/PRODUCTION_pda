<?php
	if(isset($_POST['retraite_validation'])||isset($_POST['paiement_articles'])){
		...
		ini_set('sendmail_from', 'puissancedamour@yahoo.fr');
		...
		if(isset($_POST['paiement_articles'])){
				...
				$message_txt="
					<p>
							...
							Payer maintenant afin de valider votre commande. Voici l'opération à effectuer:<br>
							<br/>
					...
					<div class='nb'>Vous trouverez ci-après la liste détaillée de votre commande d'un montant de: <b><span class='prix redd'>".money($_SESSION['PDmontant'])."</span></b></div>
					<div class='nb'>Votre commande sera traitée dans les <b>72H</b> dès reception de votre paiement</div>
					<div class='nb'>Votre commande, faute de reception sur nos compte du montant dû, <b>sera annulée le $expiration </b> (soit une semaine ouverte après la présente commande)</div>
					<ul>";
...
}else echo "noooooooooooooooooooooon email échoué";
?>
<!--
